<x-app-layout>
    ...
    <div class="py-12">
        <div class="container px-4 py-8  bg-white  mx-auto rounded-lg ">
            <h1 class="text-3xl font-bold text-center mb-8"> Posts Listing</h1>
                ...
                <table class="w-full table-auto">
                    <thead>
                        <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                            ...
                            <th class="py-3 px-6 text-left">is_publish</th>
                    ...
                    <tbody class="text-gray-600 text-sm">
                        ...
                        <tr class="border-b border-gray-200 hover:bg-gray-100">
                            ...
                            <td class="py-3 px-6 text-left">{{$post->is_published ? 'true':'false'}}</td>
