        ...
        <div class="container ">
            ...
            <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative" role="alert">
                ...
                <form class="  flex flex-col items-center  w-full  max-w-[100%]" method="POST"
                    enctype="multipart/form-data" action="{{route('posts.update',$post->id)}}">
                    @csrf
                    <div class="mb-5 w-[400px]">
                        ...
                        <input type="text" id="title" name="title"
                            ...
                            placeholder="ahmed" required value="{{old('title',$post->title)}}" />
                    </div>
                    <div class="mb-5 w-[400px]">
                        ...
                        <select name="category_id" id=""
                            ...
                            <option value="{{$category->id}}" @selected(old('category',$post->
                    ...
                    <div class="mb-5 w-[400px]">
                        ...
                        <select
                            ...
                            <option value="true" @selected(old('is_published',$post->is_published)==true )>true
                            </option>
                            <option value="false" @selected(old('is_published',$post->is_published)==false )>false
                            </option>
                        </select>
